...
// Prefer the new variable if present, fall back to the original name
const supabaseAnonKey = (import.meta.env.NEW_VITE_SUPABASE_ANON_KEY || import.meta.env.VITE_SUPABASE_ANON_KEY)?.trim();
