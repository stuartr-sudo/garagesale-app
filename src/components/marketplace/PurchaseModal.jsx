...
export default function PurchaseModal({ item, seller, onClose, onSuccess, negotiatedPrice = null }) {
  ...
  return (
    <Dialog open={true} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[85vh] overflow-auto modal-glow card-gradient">
        <DialogHeader>
        ...
        <div className="space-y-6">
          ...
          {step === 2 && (
            <>
              ...
              {deliveryMethod === 'ship' && (
                <div className="space-y-2 mt-3 p-3 bg-purple-900/20 border border-purple-500/30 rounded-lg">
                  <Label htmlFor="address" className="text-white text-sm">Shipping Address *</Label>
                  <Input
                    id="address"
                    value={shippingAddress}
                    onChange={(e) => setShippingAddress(e.target.value)}
                    placeholder="Enter your full shipping address"
                    className="h-10 rounded-lg bg-gray-900 border-gray-800 text-white"
                    required
                  />
                </div>
              )}
                ...
                <div className="space-y-1">
                  <div className="flex justify-between text-gray-300 text-sm">
                    ...
                    <span>
                      ${getDisplayPrice().toFixed(2)}
                      {negotiatedPrice && (
                        <span className="text-green-400 text-xs ml-1">(Negotiated)</span>
                      )}
                    </span>
                  </div>
                  <div className="flex justify-between text-gray-300 text-sm">
            ...
            <>
              ...
              <div className="bg-yellow-900/20 border border-yellow-500/30 rounded-lg p-3">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <h4 className="font-semibold text-yellow-200 mb-1 text-sm">Important Instructions</h4>
                    <ol className="text-xs text-yellow-100 space-y-0.5 list-decimal list-inside">
              ...
              <div className="bg-gradient-to-br from-cyan-900/30 to-blue-900/30 border-2 border-cyan-500/40 rounded-lg p-4">
                ...
                <div className="space-y-2">
                  <div className="bg-gray-900/50 rounded-lg p-2">
                    ...
                    <div className="text-sm font-semibold text-white">{seller?.bank_account_name || 'Not provided'}</div>
                  </div>
                  <div className="grid grid-cols-2 gap-2">
                    <div className="bg-gray-900/50 rounded-lg p-2">
                      <div className="text-xs text-gray-400">BSB</div>
                      <div className="text-sm font-mono font-semibold text-white">{seller?.bank_bsb || 'Not provided'}</div>
                    </div>
                    <div className="bg-gray-900/50 rounded-lg p-2">
                      <div className="text-xs text-gray-400">Account Number</div>
                      <div className="text-sm font-mono font-semibold text-white">{seller?.bank_account_number || 'Not provided'}</div>
                    </div>
                  </div>
                  <div className="bg-gray-900/50 rounded-lg p-2">
                    <div className="text-xs text-gray-400">Reference (IMPORTANT)</div>
                    <div className="text-sm font-mono font-bold text-cyan-400">ORDER-{orderId?.slice(0, 8).toUpperCase()}</div>
                  </div>
                  <div className="bg-gray-900/50 rounded-lg p-2">
                    <div className="text-xs text-gray-400">Amount to Transfer</div>
