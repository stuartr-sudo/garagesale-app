          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {AD_PLACEMENTS.map(placement => (
                <Card key={placement.value} className="bg-slate-700/80 backdrop-blur-sm shadow-xl border border-slate-600 rounded-2xl flex flex-col">
                  <CardHeader>
            ...
            <div className="mt-8 bg-slate-700/80 border border-slate-600 rounded-2xl p-6">
  ...
  return (
    <div className="min-h-screen bg-slate-800 text-gray-200">
          ...
          {ads.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {ads.map((ad) => (
                <Card
                  key={ad.id}
                  className="bg-slate-700/80 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-600 rounded-2xl overflow-hidden flex flex-col"
                >
                  <div className="relative aspect-video overflow-hidden">
                    ...
                    <div className="absolute top-3 left-3 flex gap-2 flex-wrap">
                      <Badge className={
                        ...
                        'bg-slate-700/80 text-gray-300 border-slate-500 backdrop-blur-sm'
                      }>
                        {ad.status}
                      </Badge>
                      <Badge variant="outline" className="bg-black/80 text-gray-300 border-slate-500 backdrop-blur-sm text-xs">
                  ...
                  <CardContent className="p-4 flex flex-col flex-grow">
                    <div className="flex-grow space-y-3">
                      ...
                      {ad.start_date && (
                        <div className="text-xs text-gray-500 flex items-center gap-1 bg-slate-600/50 rounded-lg px-3 py-2">
                    ...
                    <div className="mt-4 pt-3 border-t border-slate-500">
                      <div className="flex gap-2 mb-2">
                        <Button
                          ...
                          variant="outline"
                          size="sm"
                          className="flex-1 bg-slate-600 border-slate-500 hover:bg-gray-700 text-gray-300 h-9 text-xs"
                        >
                          {ad.status === 'active' ? (
                            <>
                      ...
                      <div className="flex gap-2">
                        ...
                        <Button
                          ...
                          variant="outline"
                          size="sm"
                          className="flex-1 text-red-400 border-slate-500 hover:bg-red-900/20 hover:text-red-300 h-9 text-xs"
                        >
      ...
      <Dialog open={showAddModal} onOpenChange={(open) => {
        ...
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-auto bg-slate-700/95 border-2 border-cyan-500/20 shadow-2xl shadow-cyan-500/15 ring-1 ring-cyan-400/10">
          <DialogHeader>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {formData.image_url ? (
                <div className="relative">
                  <img
                    ...
                    alt="Preview"
                    className="w-full h-48 object-cover rounded-xl border border-slate-500"
                  />
                  <Button
                    type="button"
                    variant="destructive"
                ...
                <div className="border-2 border-dashed border-slate-500 rounded-xl p-8 text-center bg-slate-600/50">
                  <input
                    type="file"
                    accept="image/*"
            ...
            <div className="flex gap-3 pt-4">
              <Button
                ...
                className="flex-1 h-12 rounded-xl bg-slate-600 border-slate-500 hover:bg-gray-700 text-white"
