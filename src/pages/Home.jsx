        ...
        <div className="max-w-5xl mx-auto px-4 md:px-6 relative">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Button
              ...
              variant="outline"
              onClick={() => handleAuthAction('Marketplace')}
              className="h-16 px-10 bg-gray-800/50 border-gray-600 hover:bg-gray-700 text-white rounded-2xl text-xl"
            >
              Browse Marketplace
          ...
          <div className="bg-gray-800/50 rounded-3xl p-8 md:p-12 border border-gray-700">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                ...
                variant="outline"
                asChild
                className="h-14 px-8 bg-gray-800/50 border-gray-600 hover:bg-gray-700 text-white rounded-2xl text-lg"
              >
