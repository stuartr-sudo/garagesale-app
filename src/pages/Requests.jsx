      ...
      <div className="p-6 md:p-8">
        <div className="max-w-7xl mx-auto">
          <div className="animate-pulse">
            <div className="h-8 bg-slate-600 rounded w-64 mb-6"></div>
    ...
    <div className="min-h-screen bg-slate-800 text-gray-200">
      <div className="p-6 md:p-8">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Search and Filters */}
          <div className="bg-slate-700/80 backdrop-blur-sm rounded-2xl shadow-lg border border-slate-600 p-6 mb-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-center">
              ...
              <div className="relative lg:col-span-6">
                ...
                <Input
                  ...
                  className="pl-12 w-full h-12 bg-slate-600 border-slate-500 focus:border-pink-500 focus:ring-pink-500 rounded-xl text-lg text-white placeholder-gray-400"
                />
              </div>
              ...
              <div className="lg:col-span-3">
                <Select value={selectedCategory} onValueChange={setSelectedCategory}>
                  <SelectTrigger className="w-full h-12 bg-slate-600 border-slate-500 rounded-xl text-white">
